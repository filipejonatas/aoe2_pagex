...
export function LeagueCard({ league }: { league: LeagueSummary }) {
  return (
    <Card className="league-card">
      ...
      <div className="league-card__stats"><div><span>Your position</span><strong>#{league.position}</strong></div><div><span>Your rating</span><strong>{league.rating}</strong></div></div>
