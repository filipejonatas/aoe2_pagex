...
export function LeaderboardTable({ players, showFilters = true, ladderLabel, recordMode = false, showPosition = true }: { players: LeaderboardPlayer[]; showFilters?: boolean; ladderLabel?: string; recordMode?: boolean; showPosition?: boolean }) {
